# WSETGlobal-downloader

A tool to download your books from WSETGlobal into PDFs.
...
1. Download the source code from [here](https://github.com/Leone25/wsetglobal-downloader/archive/refs/heads/main.zip) or click the above green button `Code` and click `Download Zip`
...
1. Open the folder of the script in a terminal (same way as installation) and run the script with node typing:
   ...
   node .
   ```
2. Enter your WSETGlobal username(email) and password
...
NOTE: You will get logged out from your account while the script is running. Do NOT login in a browser as it will break the script while it's running.
