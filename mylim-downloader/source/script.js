...
async function grabTitles() {
    ...
    let info = await fetch('https://loeda.loescher.it/mialim2/api/v1/book/sommari/', {method: "GET",headers:{"Authorization":"JWT "+token}}).then(res => res.json());
...
async function download(isbn, title) {
    ...
    let info = await fetch('https://loeda.loescher.it/mialim2/api/v1/book/pdf/' + isbn + '/', {method: "GET",headers:{"Authorization":"JWT "+token}}).then(res => res.json());
